...
//Pagina Central
    ...
    $bd= new dbMysql();
    $bd->dbConectar();
    $IdArea=isset($_GET['op']) ? $IdArea=$_GET['op'] : $_GET['op']="Inicio";
...
order by
	b.idarea,b.posicion
     ...
     if (!$bd->Error) {
      ...
      $conMarque=$bd->dbConsultar('select marquesina from configuracion limit 1');
      if (!$bd->Error) {
          $marquesina=$conMarque->fetch_assoc()['marquesina'];
      }
?>
...
<div id="Contenedor">
  ...
  <?php include("menu.php"); ?>
    ...
    <?php include('../paginas/derechos.html'); ?>
</div>
