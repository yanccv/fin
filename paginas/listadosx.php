...
<body>
	<div id="Contenedor">
      ...
      <div id="DatosUser">
		<table border="0" cellpadding="0" cellspacing="0"><tr><td width="300" align="left">Usuario: <?php echo $_SESSION['usuario']['login']; ?></td><td width="300" align="center">Nombre de Usuario: <?php echo $_SESSION['usuario']['nombre']; ?></td><td width="300" align="right">Perfil: Administrativo</td></tr></table> 
      </div>        
      <div id="FilaMenu">
