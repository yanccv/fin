...
*/
//$baseUrl = '/administrable/imagenes/';
//$baseUrl = DIRECTORY_SEPARATOR.'images'.DIRECTORY_SEPARATOR.'administrable'.DIRECTORY_SEPARATOR;
//$baseUrl ='/images/administrable/';

//Ruta Server de Internet
//  $baseUrl ='/images/administrable/admin/';


//Ruta Local
	session_start();
   //$baseUrl ="http://".$_SERVER['HTTP_HOST'].'/files/'.$_SESSION['Folder']."/";   
   $baseUrl ='/files/'.$_SESSION['Folder']."/";
...
*/
$baseDir = resolveUrl($baseUrl);
//$baseDir='/administrable/scripts/ckfinder/';
//echo $baseDir;
//exit();
/*
 * ### Advanced Settings
