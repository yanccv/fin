...
select 
	d.id,a.area,if (isnull(b.posicion),'Banner Principal',concat('Despues de ',ar.titulo)) posicion,d.titulo,d.enlace,d.banner,p.dias,p.costo*mo.cambio costototal,m.monto_oficial costo,bs.banco,c.cuenta,m.referencia,mo.moneda 
from 
	detabanner as d 
	...
	inner join debamovi as dm on dm.detabanners=d.id 
	inner join movimientos as m on m.id=dm.movimiento 
	inner join cuentas as c on c.id=m.cuenta 
	inner join bancos as bs on c.banco=bs.id 
	inner join clientes as cl on cl.cedula=d.idcliente
	inner join paises as ps on ps.id=cl.pais 
	inner join monedas as mo on mo.id=ps.monedaoficial 
where 
	d.estado='I' and d.id=?",array((int) $_GET['id']));        
        if ($bd->Error){
	...
	<div id="Contenedor">
      ...
      <div id="FilaMenu">
		...
		<div class="FormDatos">
            ...
            <input type="hidden" id="idform" name="idform" value="ABanner" />
            ...
            <div class="CampoCompleto">
               ...
               <div class="CampoLargo"><?php echo $Banner['posicion']; ?></div>
            	<div class="Limpiador"></div>
            </div> 
            <div class="CampoCompleto">
            	<div class="EtiquetaCorta">Plan:</div>
               <div class="CampoLargo"><?php echo $Banner['dias']; ?> días x <?php echo $Banner['costototal']; ?></div>
            	<div class="Limpiador"></div>
            </div>                                    
            <div class="CampoCompleto">
            	<div class="EtiquetaCorta">Titulo:</div>
               <div class="CampoLargo"><?php echo $Banner['titulo']; ?></div>
            	<div class="Limpiador"></div>
            </div>
            <div class="CampoCompleto">
               <div class="EtiquetaCorta">Enlace:</div>
               <div class="CampoLargo"><?php echo $Banner['enlace']; ?></div>
               <div class="Limpiador"></div>
            </div> 
            ...
            <div class="CampoCompleto">
                ...
                <div class="CampoMedio"><?php echo $Banner['banco']; ?></div>
            	 <div class="EtiquetaCorta">Cuenta:</div>
                <div class="CampoMedio"><?php echo $Banner['cuenta']; ?></div>
            ...
            <div class="CampoCompleto">
                ...
                <div class="CampoMedio"><?php echo $Banner['referencia']; ?></div>
            	 <div class="EtiquetaCorta">Monto:</div>
                <div class="CampoMedio"><?php echo $Banner['costo']. " ".$Banner['moneda']; ?></div>
